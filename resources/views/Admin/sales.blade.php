...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .notification-item { padding: 12px 15px; border-bottom: 1px solid #e2e8f0; transition: background 0.2s; cursor: pointer; }
        .notification-item:hover { background: #f8fafc; }
        .notification-item.unread { background: #e8f5e9; border-left: 3px solid #28a745; }
        .notification-title { font-weight: 600; color: #1e3a38; margin-bottom: 5px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 5px; font-size: 14px; }
        ...
        @media (max-width: 768px) {
            ...
            .stats-container h3 { font-size: 12px; }
        }
        @media (max-width: 480px) {
            ...
            .stats-container h2 { font-size: 20px; }
            .recordcount strong { font-size: 12px; }
        ...
        @media (max-height: 600px) {
            ...
            .product-table { margin: 15px 20px; }
        }
    </style>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <form action="{{ route('admin.sales') }}" method="GET"><div class="nav-item active"><button><i class="fas fa-chart-line"></i><span>Sales</span></button></div></form>
    ...
    <div class="main-content">
        ...
        <!-- STATS -->
        <div class="stats">
            <div class="stats-container"><h3>Total Sales Today</h3><h2>{{ $totalSalesToday ?? 0 }}</h2><p>Transactions</p></div>
            <div class="stats-container"><h3>Revenue Today</h3><h2>₱{{ number_format($totalRevenueToday ?? 0, 2) }}</h2><p>Total Sales</p></div>
            <div class="stats-container"><h3>Pending Payments</h3><h2>₱{{ number_format($pendingPayments ?? 0, 2) }}</h2><p>Awaiting Payment</p></div>
        </div>
        ...
        <div class="sales-view">
            ...
            <div class="sales-status">
                ...
                <div class="right">
                    <div class="recordcount"><span class="count">Total Sales: </span><strong>{{ $sales->total() }}</strong></div>
                    <div class="add-new-sale"><button id="open_new_sale_modal" class="new-sale-button"><i class="fas fa-plus"></i> New Sale</button></div>
                </div>
            </div>
