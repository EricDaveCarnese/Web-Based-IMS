    ...
    <style>
        * {
        ...
        @media (max-width: 860px) {
            ...
            .action-button, .cancel-order-btn {
                padding: 4px 10px;
                font-size: 11px;
            }
        }
            ...
            <div class="purchase-container">
                <div class="search-container">
                    <div class="search-wrapper">
                        <input type="text" id="searchInput" class="search-input" placeholder="Search by supplier..." autocomplete="off" value="{{ request('search') }}">
        ...
        function showSuggestions() {
            ...
            if (matches.length > 0 && dropdown) {
                ...
                for (var i = 0; i < matches.length; i++) {
                    ...
                    html += '<div class="autocomplete-item" onclick="selectSupplier(\'' + escapedName + '\')">' +
                ...
                dropdown.innerHTML = '<div class="no-results">No suppliers found matching "' + query + '"</div>';
                dropdown.classList.add('show');
            }
        }
